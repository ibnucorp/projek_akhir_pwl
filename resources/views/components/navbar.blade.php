  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        @if (Auth::check())
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    @endif
                    <a class="dropdown-item" href="{{ route('profile.logout') }}">Logout</a>
                </div>
            </li>
        @else
            <a type="button" href="login" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center">Mulai Donasi</a>
        @endif
